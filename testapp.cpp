...
int APIENTRY WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nCmdShow)
{
	...
	while (1)
	{
		...
		else
		{
			...
			t[1] = (mins % 10) + '0';
			t[0] = ((mins / 10) % 10) + '0';
			surface->Print( t, tpos, 1, 0xffffffff );
			strcpy( t, "0000k" );
			int r = (int)((tracer->m_RaysCast) / (ftime / 1000.0f));
			t[0] += (r / 1000000) % 10;
			t[1] += (r / 100000) % 10;
			t[2] += (r / 10000) % 10;
			t[3] += (r / 1000) % 10;
			surface->Print( t, tpos, 9, 0xffffffff );
			strcpy( t, "00.0M" );
			r = tracer->m_Intersections;
			t[0] += (r / 10000000) % 10;
			t[1] += (r / 1000000) % 10;
			t[3] += (r / 100000) % 10;
			surface->Print( t, tpos + 34, 9, 0xffffffff );
			strcpy( t, "00.0" );
			r = (tracer->m_Intersections * 10) / (tracer->m_RaysCast);
			t[0] += (r / 100) % 10;
			t[1] += (r / 10) % 10;
			t[3] += (r / 1) % 10;
			surface->Print( t, tpos + 64, 1, 0xffffffff );
			tpos += 120;
		}
	}
	return 1;
